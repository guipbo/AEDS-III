...
void printStatement(){
    printf("\n********** EXERCÍCIO 03 **********");
    printf("\n\nData uma entrada de Dados do usuário de números inteiros preencha uma arvore binária busca e no final exiba as seguintes informações. \n    a. Se é uma árvore completa;\n    b. Se ela está balanceada. (A análise a ser seguida é a mesma utilizada para AVL)");
    printf("\n");
}
